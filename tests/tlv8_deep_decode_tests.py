...
#             }
#         }
#         result = tlv8.deep_decode(input_data, structure)
#         expected = tlv8.EntryList([
...
#             b'\x00\x00' + \
#             b'\x02\x01\x01'
#         result = tlv8.deep_decode(data, expected={2: tlv8.DataType.INTEGER})
...
#         }
#         result = tlv8.deep_decode(data, expected_data_structure)
#         expected_data = tlv8.EntryList([
...
#         data = b'\x01\x02Hi'
#         result = tlv8.deep_decode(data, {1: tlv8.DataType.STRING})
#         expected_data = tlv8.EntryList([
#             tlv8.Entry(1, 'Hi')
#         ])
#         self.assertEqual(result, expected_data)
...
#         self.assertRaises(ValueError, tlv8.deep_decode, data, structure)
# 
#     def test_decode_error_unknown_type(self):
#         data = b'\x01\x05\x01\x01\x01\x01\x01'
#         structure = {1: "string"}
#         with self.assertRaises(ValueError) as error_context:
#             tlv8.deep_decode(data, structure)
